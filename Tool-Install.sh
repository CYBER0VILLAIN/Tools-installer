...
echo -b "AUTHOR    : CYBER VILLAIN $green " |lolcat
echo -b "_____________________________________________________________" | lolcat
...
ctrl_c() {
clear
echo -b $green"[#]> TOOLS WILL INSTALL IN YOUR TERMUX FOLDER  " |lolcat
echo -b $green"[#]> Thanks For Using My Tools" |lolcat
sleep 1
echo -b $green"[#]> IF YOU WANT LEARN HACKING SO VISIT MY WEBSITE https://villainstore.site " |lolcat

echo -b $green"[#]> See you Again SCRIPTKIDDIES😎 :)..." |lolcat
figlet CYBER VILLAIN | lolcat
sleep 1
exit
}
...
echo -e "######################################" | lolcat
echo -e "#TERMUX LIST TOOLS#" | lolcat
echo -e "######################################" | lolcat
...
echo -e "============================" | lolcat
echo -e "╭─[VISIT- https://villainstore.site]"
read -p "   ╰─SELECT OPTION=" pil;
...
00) echo "AUTHOR: CYBER VILLAIN" | lolcat
echo " IF ANYONE WANT LEARN HACKING SO VISIT MY WEBSITE https://villainstore.site" | lolcat
figlet CYBER VILLAIN | lolcat
exit
;;
